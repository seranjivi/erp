...
const SOW_PAGE_CSS = `
/* ── SOW PAGE LAYOUT ── */
.sow-page{display:flex;flex:1;min-height:0;overflow:hidden;background:#f0f2f5}
...
const APPR_CSS = `
.appr-page{display:flex;flex:1;min-height:0;overflow:hidden;background:#f0f2f5}
